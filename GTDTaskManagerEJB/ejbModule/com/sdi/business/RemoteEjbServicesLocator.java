...
public class RemoteEjbServicesLocator implements Services{
	...
	private static final String BASE_JNDI_KEY = "GTDTaskManager/GTDTaskManagerEJB/";
	private static final String ADMIN_SERVICE_JNDI_KEY = BASE_JNDI_KEY
			+ "EjbAdminService!com.sdi.business.impl.admin.RemoteAdminService";
	private static final String TASK_SERVICE_JNDI_KEY = BASE_JNDI_KEY
			+ "EjbTaskService!com.sdi.business.impl.task.RemoteTaskService";
	private static final String USER_SERVICE_JNDI_KEY = BASE_JNDI_KEY
			+ "EjbUserService!com.sdi.business.impl.user.RemoteUserService";
